...
|-----------|-------------------|------------------|-----------------------|
| Chunk | 154.2µs / 157.4µs (1.02x) | 2693 / 44295 (16.45x) | 1 / 101 (101.00x) |
| Filter | 158.4µs / 158.6µs (1.00x) | 8 / 40964 (5120.50x) | 0 / 1 (∞) |
| Map | 151.3µs / 152.2µs (1.01x) | 35 / 40965 (1170.43x) | 0 / 1 (∞) |
| Pipeline Filter → Map → Take → Reduce | 152.3µs / 163.2µs (1.07x) | 61 / 81924 (1343.02x) | 0 / 2 (∞) |
| Unique | 173.5µs / 171.2µs (0.99x) | 188763 / 188742 (1.00x) | 19 / 18 (0.95x) |
<!-- bench:embed:end -->
