...
| Operation | ns/op (col/lo, ×) | B/op (col/lo, ×) | allocs/op (col/lo, ×) |
|-----------|-------------------|------------------|-----------------------|
| Chunk | 151.1µs / 152.7µs (1.01x) | 2694 / 44291 (16.44x) | 1 / 101 (101.00x) |
| Filter | 156.2µs / 159.7µs (1.02x) | 3 / 40963 (13654.33x) | 0 / 1 (∞) |
| Map | 151.1µs / 150.3µs (0.99x) | 29 / 40969 (1412.72x) | 0 / 1 (∞) |
| Pipeline Filter→Map→Take→Reduce | 139.9µs / 106.7µs (0.76x) | 61 / 81923 (1343.00x) | 0 / 2 (∞) |
| Unique | 174.8µs / 169.5µs (0.97x) | 188763 / 188739 (1.00x) | 19 / 18 (0.95x) |
<!-- bench:embed:end -->
