...
|---|-------------------|------------------|-----------------------|
| Chunk | 1.3µs / 36.8µs (29.21x) | 12288 / 460288 (37.46x) | 1 / 501 (501.00x) |
| Filter | 32.8µs / 43.8µs (1.33x) | 0 / 401408 (∞) | 0 / 1 (∞) |
| Map | 19.9µs / 29.0µs (1.46x) | 0 / 401408 (∞) | 0 / 1 (∞) |
| Pipeline F→M→T→R | 36.8µs / 38.3µs (1.04x) | 0 / 606208 (∞) | 0 / 2 (∞) |
<!-- bench:embed:end -->
